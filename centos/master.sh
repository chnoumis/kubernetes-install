...
echo KUBELET_PORT="--kubelet_port=10250" >> /etc/kubernetes/apiserver
...
echo KUBE_ADMISSION_CONTROL="--admission_control=NamespaceLifecycle,NamespaceExists,LimitRanger,SecurityContextDeny,ResourceQuota" >> /etc/kubernetes/apiserver
